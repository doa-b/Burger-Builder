...
class Auth extends Component {
        ...
        controls: {
            ...
            password: {
                ...
                validation: {
                    required: true,
                    minLength: 6,
                    validationText: 'Password must be at least 6 chars'
                },
                valid: false,
                touched: false
            }
    ...
    submitHandler = (event) => {
        ...
        this.props.onAuth(
            this.state.controls.email.value, this.state.controls.password.value, this.state.isSignup );
    };
    ...
    render() {
        ...
        return (
            <div className={classes.Auth}>
                {authRedirect}
                <h2>
                    {(this.state.isSignup) ? 'Sign Up' : 'Sign In'}</h2>
                {errorMessage}
                ...
                <p>example: a@test.nl pw: 123456</p>
            </div>);
    }
}
